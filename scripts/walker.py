...
class WFunc:
    ...
    def __init__(self,**kwargs):
        ...
        self.parameters["swing_scale"]=0.2 #0.2
        self.parameters["step_scale"]=0.3 #0.3
        self.parameters["step_offset"]=0.55 #0.55
	...
	angles={}
	if phase:
		angles["l_hip_swing_joint"] = self.pfn["l_hip_swing_joint"].get(x)
		angles["r_hip_swing_joint"] = self.pfn["r_hip_swing_joint"].get(x)
		angles["l_hip_lateral_joint"] = -self.pfn["l_hip_lateral_joint"].get(x)
		angles["r_hip_lateral_joint"] = -self.pfn["r_hip_lateral_joint"].get(x)
		angles["l_knee_joint"] = -self.pfn["l_knee_joint"].get(x)
		angles["r_knee_joint"] = -self.pfn["r_knee_joint"].get(x)
		angles["l_ankle_swing_joint"] = self.pfn["l_ankle_swing_joint"].get(x)
		angles["r_ankle_swing_joint"] = self.pfn["r_ankle_swing_joint"].get(x)
		angles["l_ankle_lateral_joint"] = -self.pfn["l_ankle_lateral_joint"].get(x)
		angles["r_ankle_lateral_joint"] = -self.pfn["r_ankle_lateral_joint"].get(x)
	else:
		angles["l_hip_swing_joint"] = self.afn["l_hip_swing_joint"].get(x)
		angles["r_hip_swing_joint"] = self.afn["r_hip_swing_joint"].get(x)
		angles["l_hip_lateral_joint"] = -self.afn["l_hip_lateral_joint"].get(x)
		angles["r_hip_lateral_joint"] = -self.afn["r_hip_lateral_joint"].get(x)
		angles["l_knee_joint"] = -self.afn["l_knee_joint"].get(x)
		angles["r_knee_joint"] = -self.afn["r_knee_joint"].get(x)
		angles["l_ankle_swing_joint"] = self.afn["l_ankle_swing_joint"].get(x)
		angles["r_ankle_swing_joint"] = self.afn["r_ankle_swing_joint"].get(x)
		angles["l_ankle_lateral_joint"] = -self.afn["l_ankle_lateral_joint"].get(x)
		angles["r_ankle_lateral_joint"] = -self.afn["r_ankle_lateral_joint"].get(x)
